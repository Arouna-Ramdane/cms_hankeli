...
class ClientController extends Controller
{
    ...
    'contact'    => 'required|integer|unique:personnes,contact',
    'adresse'    => 'max:255',
], [
    'first_name.required' => 'Le prénom est obligatoire.',
    'first_name.alpha' => 'Le prénom doit ếtre alphabetique.',
    'first_name.max' => 'Le prénom doit impeut plus court.',
    'name.required'       => 'Le nom est obligatoire.',
    'name.alpha'       => 'Le nom doit ếtre alphabetique.',
    'name.max'       => 'Le nom doit impeut plus court.',
    'contact.required'    => 'Veuillez saisir un contact.',
    'contact.integer' => 'Ce contact doit être numerique.',
    ...
    public function update(Request $request, Client $client)
    {
        ...
        'first_name' => 'required|alpha|max:255',
        'name' => 'required|alpha|max:255',
        'contact' => 'required|integer|unique:personnes,contact,'. $client->personne_id .',personne_id',
        ...
        'contact.unique' => 'Ce contact existe déjà dans la base.',
        'contact.integer' => 'Ce contact doit être numerique.',
        'adresse.string' => 'L’adresse doit être alphabetique.',
    ]);
