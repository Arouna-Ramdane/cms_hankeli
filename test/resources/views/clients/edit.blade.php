...
retour
    ...
    <div class="max-w-xl mx-auto mt-6 bg-white shadow-md rounded-xl p-8 justify-center">
        ...
        <form action="{{ route('clients.update', $personne->client_id)}}" method="POST">
            ...
            <div>
                <input type="text" name="first_name" value="{{ $personne->first_name }}"  placeholder="Prénom"
            ...
            <div>
                <input type="text" name="name" value="{{ $personne->name }}"  placeholder="Nom"
                 class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring focus:ring-blue-200">
                 @error('name')
                        <div class="text-red-500 text-sm">{{ $message }}</div>
                    @enderror
            ...
            <div>
                <input type="tel" name="contact" value="{{ $personne->contact }}"  placeholder="Contact"
                    class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring focus:ring-blue-200">
                    @error('contact')
                        <div class="text-red-500 text-sm">{{ $message }}</div>
                    @enderror
