...
<div class="min-h-screen bg-gray-100 p-6">
    ...
    <div class="max-w-2xl mx-auto bg-white shadow-lg rounded-lg p-8">
        ...
        <!-- Form -->
        <form action="{{ route('clients.update', $personne->client_id)}}" method="POST" class="space-y-5">
            @csrf
            @method('PUT')
            ...
            <div class="grid md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="text" name="first_name" value="{{ $personne->first_name }}" placeholder="Nom"
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ $personne->name }}" placeholder="Prénom"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none">
                    @error('name')
                        <span class="text-red-600 text-sm mt-1 block">{{ $message }}</span>
                    @enderror
